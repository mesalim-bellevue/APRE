...
// Imported Sales By Customer Component
import { SalesByCustomerComponent } from './reports/sales/sales-by-customer/sales-by-customer.component';
// Imported Call Duration Display Component
import { CallDurationDisplayComponent } from './reports/agent-performance/call-duration-display/call-duration-display.component';
// Imported Feedback By Product Component
...
export const salesReportRoutes: Routes = [
  ...
  // Add route to sales by customer
  {
...
export const agentPerformanceRoutes: Routes = [
  ...
  // Add route to call duration display
  {
    path: 'call-duration-by-date-range-display',
    component: CallDurationDisplayComponent
  }
];
...
export const customerFeedbackRoutes: Routes = [
  ...
  // Add route to customer feedback by product
  {
